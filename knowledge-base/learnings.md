...
- Send only validated Bluesky CDN images to Anthropic; fail closed on video because Messages vision has no video input. ([reports/2026-08-25-bluesky-media-provider-boundaries.md](reports/2026-08-25-bluesky-media-provider-boundaries.md))
- xAI exposes X-only video understanding without pipeline details; Bluesky video needs a separate bounded design. ([reports/2026-08-25-bluesky-media-provider-boundaries.md](reports/2026-08-25-bluesky-media-provider-boundaries.md))
